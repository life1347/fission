...
func New(logger *zap.Logger, routerUrl string, mqCfg messageQueue.MessageQueueConfig) (messageQueue.MessageQueue, error) {
...
func (kafka Kafka) Subscribe(trigger *fv1.MessageQueueTrigger) (messageQueue.MessageQueueSubscription, error) {
...
func (kafka Kafka) Unsubscribe(subscription messageQueue.MessageQueueSubscription) error {
